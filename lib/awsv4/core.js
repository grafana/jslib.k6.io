...
function request(method, service, region, target, path="", body=null, query="", params= {}) {
    var options =  {};
    options.key = options.key || __ENV.AWS_ACCESS_KEY_ID;
    options.secret = options.secret || __ENV.AWS_SECRET_ACCESS_KEY;
    ...
    var signature = generateSignature(service, method, path, query, body, options);
    ...
    var url = options.protocol.concat( "://", service ,".", region, ".amazonaws.com")

    return http.request(method, url, body , params)
}
exports.request=request;

function generateSignature(service, method, path ,query, body, options) {
