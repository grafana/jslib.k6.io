...
var humanizeValueTestCases = [
    {
        type: 'counter', contains: 'default', tests: [
    ...
    {
        type: 'gauge', contains: 'default', tests: [
            { value: 1.0, expResults: ['1', '1', '1', '1'] },
            { value: 1.5, expResults: ['1.5', '1.5', '1.5', '1.5'] },
            { value: 1.54321, expResults: ['1.54321', '1.54321', '1.54321', '1.54321'] },
        ]
    ...
    {
        type: 'trend', contains: 'default', tests: [
            { value: 1.0, expResults: ['1', '1', '1', '1'] },
            { value: 1.5, expResults: ['1.5', '1.5', '1.5', '1.5'] },
            { value: 1.54321, expResults: ['1.54321', '1.54321', '1.54321', '1.54321'] },
        ]
    ...
    {
        type: 'counter', contains: 'time', tests: [
            ...
            { value: D(1234567890123), expResults: ['20m34s', '1234.57s', '1234567.89ms', '1234567890.12µs'] },
            { value: D(12345678901234), expResults: ['3h25m45s', '12345.68s', '12345678.90ms', '12345678901.23µs'] },
            { value: D(123456789012345), expResults: ['34h17m36s', '123456.79s', '123456789.01ms', '123456789012.35µs'] },
        ]
    },
    {
        type: 'gauge', contains: 'time', tests: [
            { value: D(1), expResults: ['1ns', '0.00s', '0.00ms', '0.00µs'] },
            { value: D(12), expResults: ['12ns', '0.00s', '0.00ms', '0.01µs'] },
            { value: D(123), expResults: ['123ns', '0.00s', '0.00ms', '0.12µs'] },
            { value: D(1234), expResults: ['1.23µs', '0.00s', '0.00ms', '1.23µs'] },
    ...
    {
        type: 'trend', contains: 'time', tests: [
            { value: D(1), expResults: ['1ns', '0.00s', '0.00ms', '0.00µs'] },
            { value: D(12), expResults: ['12ns', '0.00s', '0.00ms', '0.01µs'] },
            { value: D(123), expResults: ['123ns', '0.00s', '0.00ms', '0.12µs'] },
            { value: D(1234), expResults: ['1.23µs', '0.00s', '0.00ms', '1.23µs'] },
    ...
    {
        type: 'rate', contains: 'default', tests: [
    ...
    {
        type: 'counter', contains: 'data', tests: [
...
function runHumanizeValueTestCase(metric, value, expResults) {
    for (var i = 0; i < timeUnits.length; i++) {
        ...
        if (!check(result, checks)) {
            console.error(
                'Expected humanizeValue(' + metric.type + ', ' + metric.contains + ', "' + timeUnits[i] + '", '
                + value + ') to be "' + expResults[i] + '" but it was "' + result + '"'
            );
        }
    }
}
